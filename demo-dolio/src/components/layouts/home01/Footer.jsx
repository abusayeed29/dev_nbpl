                ...
                <footer id="footer" className="footer footer-s1 footer-s1-home1">
                    ...
                    <div className="container">
                        ...
                        <div className="col-lg-12">
                            ...
                            <p className="address">H # 28/A, R # 83, Gulshan - 2, Dhaka - 1212</p>
                            <p className="mail">info@navana-nbpl.com</p>
                            <p className="phone">+88 01730 729 305</p>
                            </div>
                        </div>
                        <div className="col-lg-12">
