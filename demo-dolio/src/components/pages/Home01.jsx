...
import {Header,Banner, Testimonial, ShapeIcon, About, Quality, Specilizing, Portfolio, Equipment, Client, Education, Footer} from '../layouts/home01/index';
                        ...
                        <div className="section slide-personal-Intro-second slide-dark">
                            <section className="testimonial s1 shape-am" id="testimonial">
                                ...
                                <div className="animate-element wow delay5 fadeZooming" data-wow-delay="0.5s">
                                    <h2 className="text-client-love">Message from Honorable Vice Chairman</h2>
                                </div>
                                <Testimonial />
                            </section>
                        </div>
